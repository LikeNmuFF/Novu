...
import { getDb, getStudentReports, deleteStudentReport } from '../services/database';
...
export default function TeacherDashboardScreen({
  ...
  const loadData = useCallback(async () => {
    try {
      ...
      const studentReports = await getStudentReports(user.id!);
  ...
  const handleDeleteReport = async (report: StudentReport) => {
    try {
          ...
          reports.map((report, idx) => (
            ...
            >
              ...
              <View style={styles.reportInfo}>
                <Text style={styles.reportName}>{report.student_name}</Text>
                <Text style={styles.reportGrade}>{report.grade} • {report.average_score}% avg</Text>
                <Text style={styles.reportDate}>
                  {new Date(report.scanned_at).toLocaleDateString()}
                </Text>
              </View>
              <TouchableOpacity
